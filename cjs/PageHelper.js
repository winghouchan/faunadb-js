...
var _Filter = _interopRequireDefault(require('./query/Filter'))

var _Map = _interopRequireDefault(require('./query/Map'))

var _Paginate = _interopRequireDefault(require('./query/Paginate'))
...
PageHelper.prototype.map = function(lambda) {
  ...
  rv._faunaFunctions.push(function(q) {
    return (0, _Map.default)(q, lambda)
  })
...
PageHelper.prototype.filter = function(lambda) {
  ...
  rv._faunaFunctions.push(function(q) {
    return (0, _Filter.default)(q, lambda)
  })
...
PageHelper.prototype._retrieveNextPage = function(cursor, reverse) {
  ...
  var q = (0, _Paginate.default)(this.set, opts)
