...
function FetchAdapter(options) {
  ...
  if ((0, _util.isNodeEnv)() && options.keepAlive) {
...
FetchAdapter.prototype.execute = function(options) {
  ...
  return this._fetch(
    (0, _util.formatUrl)(options.origin, options.path, options.query),
    {
...
function attachStreamConsumer(response, consumer) {
  ...
  try {
    ...
    throw new _errors.StreamsNotSupported(
...
function remapFetchError(error, useTimeout) {
  ...
  return useTimeout ? new _errors.TimeoutError() : new _errors.AbortError()
}
/**
