...
var _common = require('./query/common')

var _RequestResult = _interopRequireDefault(require('./RequestResult'))

var _values = require('./values')

var _http = _interopRequireDefault(require('./_http'))
...
function Client(options) {
  options = (0, _util.applyDefaults)(options, {
    domain: 'db.fauna.com',
    scheme: 'https',
    port: null,
    secret: null,
  ...
  this._http = new _http.default(options)
}
/**
 * Current API version.
 *
...
Client.apiVersion = _package.default.apiVersion
/**
...
Client.prototype.query = function(expression, options) {
  return this._execute('POST', '', (0, _common.wrap)(expression), null, options)
}
/**
...
Client.prototype.paginate = function(expression, params, options) {
  params = (0, _util.defaults)(params, {})
  options = (0, _util.defaults)(options, {})
  return new _PageHelper.default(this, expression, params, options)
}
/**
...
Client.prototype._execute = function(method, path, data, query, options) {
  query = (0, _util.defaults)(query, null)

  if (
    path instanceof _values.Ref ||
    (0, _util.checkInstanceHasProperty)(path, '_isFaunaRef')
  ) {
    path = path.value
  }
  ...
  return this._http
    ...
    .then(function(response) {
      ...
      var responseObject = (0, _json.parseJSON)(response.body)
      var result = new _RequestResult.default(
        method,
        path,
        query,
        body,
...
Client.prototype._handleRequestResult = function(response, result, options) {
  ...
  _errors.FaunaHTTPError.raiseForStatusCode(result)
}
