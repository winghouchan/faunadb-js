...
exports.StreamsNotSupported = StreamsNotSupported
exports.StreamErrorEvent = StreamErrorEvent
...
;(0, _util.inherits)(FaunaError, Error)
/**
...
;(0, _util.inherits)(InvalidValue, FaunaError)
/**
 * Exception thrown by this client library when an invalid
 * value is provided as a function argument.
 *
...
;(0, _util.inherits)(InvalidArity, FaunaError)
/**
...
;(0, _util.inherits)(FaunaHTTPError, FaunaError)
/**
...
;(0, _util.inherits)(BadRequest, FaunaHTTPError)
/**
 * A HTTP 401 error.
 * @param {RequestResult} requestResult
 * @extends module:errors~FaunaHTTPError
...
;(0, _util.inherits)(Unauthorized, FaunaHTTPError)
/**
 * A HTTP 403 error.
 * @param {RequestResult} requestResult
 * @extends module:errors~FaunaHTTPError
...
;(0, _util.inherits)(PermissionDenied, FaunaHTTPError)
/**
 * A HTTP 404 error.
 * @param {RequestResult} requestResult
 * @extends module:errors~FaunaHTTPError
...
;(0, _util.inherits)(NotFound, FaunaHTTPError)
/**
 * A HTTP 405 error.
 * @param {RequestResult} requestResult
 * @extends module:errors~FaunaHTTPError
...
;(0, _util.inherits)(MethodNotAllowed, FaunaHTTPError)
/**
 * A HTTP 500 error.
 * @param {RequestResult} requestResult
 * @extends module:errors~FaunaHTTPError
...
;(0, _util.inherits)(InternalError, FaunaHTTPError)
/**
 * A HTTP 503 error.
 * @param {RequestResult} requestResult
 * @extends module:errors~FaunaHTTPError
...
;(0, _util.inherits)(UnavailableError, FaunaHTTPError)
/**
...
;(0, _util.inherits)(StreamError, FaunaError)
/**
...
;(0, _util.inherits)(StreamsNotSupported, StreamError)
/**
...
;(0, _util.inherits)(StreamErrorEvent, StreamError)
/**
...
;(0, _util.inherits)(TimeoutError, Error)
/**
...
;(0, _util.inherits)(AbortError, Error)
